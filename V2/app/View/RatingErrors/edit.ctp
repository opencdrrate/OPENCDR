...
<?php echo $this->Form->create('CallrecordmasterHeld');?>
	<fieldset>
		<legend><?php echo __('Edit Callrecordmaster Held'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('CallrecordmasterHeld.callid')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('CallrecordmasterHeld.callid'))); ?></li>
