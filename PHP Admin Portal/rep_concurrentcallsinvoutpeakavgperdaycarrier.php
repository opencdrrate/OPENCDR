...
HEREDOC;
	...
	$query = "select cast(calldatetime as date) as \"Date\", carrierid, direction, max(concurrentcalls) as \"Peak\", avg(concurrentcalls) as \"Average\" from concurrentcallsdirectioncarrier
...
$csv_output .= $myrow['Date']. $myrow['carrierid']. "|". $myrow['direction']. "|". $myrow['Peak']. "|". $myrow['Average']. "\n";
