...
(
  ...
  CONSTRAINT tollfreeoriginationratemaster_pkey PRIMARY KEY (customerid , billedprefix , effectivedate ),
  CONSTRAINT tollfreeoriginationratemaster_rowid_key UNIQUE (rowid )
)
*/

class psql_tollfreeoriginationratemaster extends SQLTable{
	public $table_name = 'tollfreeoriginationratemaster';
	...
	function psql_tollfreeoriginationratemaster($connectString){
