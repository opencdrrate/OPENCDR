<?php
	...
	include 'lib/FileUtils/IntrastateRateFileImporter.php';
	include 'DAL/table_intrastateratemaster.php';
	...
	<!-- THE IMPORT BUTTON -->
	<form id="action" action="controllers/ajax_intrastaterate_controller.php?customerid={$customerid}" method="POST">
