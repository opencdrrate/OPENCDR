...
HEREDOC;
	...
	$query = "select carrierid, cast(avg(\"Calls\") as bigint) as \"Calls\", avg(\"RawDuration\") as \"RawDuration\", avg(\"BilledDuration\") as \"BilledDuration\" from vwcallspermonthpercarrier where direction = 'I'
		 group by carrierid
		 order by carrierid;";
...
?>
<head>
<?php echo GetPageHead("Average Monthly Inbound Calls Per Carrier", "reports.php")?>
</head>
