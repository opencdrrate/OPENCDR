...
<td>{$myrow['lrn']}</td>
<td>{$region->FormatCurrency($myrow['lrndipfee'])}</td>
<td>{$myrow['billednumber']}</td>
<td>{$myrow['billedprefix']}</td>
<td>{$region->FormatDateTime($myrow['rateddatetime'])}</td>
<td>{$region->FormatCurrency($myrow['retailrate'])}</td>
<td>{$myrow['cnamdipped']}</td>
<td>{$region->FormatCurrency($myrow['cnamfee'])}</td>
