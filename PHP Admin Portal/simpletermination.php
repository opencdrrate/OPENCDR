...
include_once 'config.php';
	...
	$controllerPath = $sharedFolder . "controllers/ajax_simpletermination_controller.php";
	...
	if(isset($_GET['deleteall'])){
		pg_query("delete from simpleterminationratemaster where customerid='".$customerid."'");
	}
...
?>
	...
	<?php echo GetPageHead('View Customer Simple Termination Rates', 'rates.php', $javascripts);?>
	<div id="body">
	<?php echo $errors;?>
	<?php
	...
	<br>
	<form action="simpletermination.php?deleteall=1&customerid=<?php echo $customerid?>" method="POST" name="deleteAllAction">
	</form>
	<form action="simpletermination.php?delete=1&customerid=<?php echo $customerid?>" method="POST" name="deleteAction">
	<?php echo $htmltable;?>
	</form>
