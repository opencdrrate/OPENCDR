<?php
	...
	if(isset($_GET['deleteall'])){
		pg_query("delete from interstateratemaster where customerid='".$customerid."'");
	}
...
?>
	...
	<?php echo GetPageHead('View Customer Interstate Rates', 'rates.php',$javascripts);?>
	<div id="body">
	<?php echo $errors;?>
	<?php
	...
	<br>
	<form action="interstaterates.php?deleteall=1&customerid=<?php echo $customerid?>" method="POST" name="deleteAllAction">
	</form>
	<form action="interstaterates.php?delete=1&customerid=<?php echo $customerid?>" method="POST" name="deleteAction">
	<?php echo $htmltable;?>
	</form>
	</div>
