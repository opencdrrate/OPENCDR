<?php
	...
	ini_set('include_path', '/var/www/html/');
 	...
 	if (isset($_POST['submit'])) {	
		...
		$activationdate = isset($_REQUEST["date5"]) ? $_REQUEST["date5"] : "";
		...
		if ($good == 0) {
     			...
     			$sql = "INSERT INTO recurringchargemaster (customerid, activationdate, unitamount, quantity, chargedesc) VALUES ('$customerid', '$activationdate', '$unitamount', '$quantity', '$chargedesc')";
			...
			$url = "listcustomerrecurringcharges.php?customerid=$customerid";
 ...
 ?> 
<?php echo GetPageHead("Add Recurring Charge to $customerid", "rates.php")?>
</head>
   <div id="body">  
