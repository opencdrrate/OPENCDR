<div class="callsbycustomerandtype index">
	<h2><?php echo __('Average monthly outbound calls by carrier and rate center');?></h2>
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $item['Callspermonthpercarrierratecenter']['carrierid']?></td>
		<td><?php echo $item['Callspermonthpercarrierratecenter']['ratecenter']?></td>
