<div class="internationalratemasters form">
<?php echo $this->Form->create('Internationalrates', array('enctype' => 'multipart/form-data', 'action'=>'import') );?>
	<fieldset>
		<legend><?php echo __('Upload International Rate File'); ?></legend>
