...
<?php echo $this->Form->create('Tieredoriginationrates', array('enctype' => 'multipart/form-data', 'action'=>'import') );?>
	<fieldset>
		<legend><?php echo __('Upload tiered origination rate file'); ?></legend>
