<div class="intrastateratemasters index">
	<h2><?php echo __('Intrastate rates');?></h2>
	<div class="paging">
 ...
 |
	...
	<?php
	$i = 0;
	foreach ($intrastateratemasters as $intrastateratemaster):
		$class = null;
		if ($i++ % 2 == 0) {
			$class = ' class="altrow"';
		}
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $intrastateratemaster['Intrastateratemaster']['effectivedate']; ?>&nbsp;</td>
		<td><?php echo $intrastateratemaster['Intrastateratemaster']['npanxxx']; ?>&nbsp;</td>
		<td><?php echo $intrastateratemaster['Intrastateratemaster']['retailrate']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $intrastateratemaster['Intrastateratemaster']['rowid'], $customerid), null, sprintf(__('Are you sure you want to delete # %s?', true), $intrastateratemaster['Intrastateratemaster']['rowid'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
