<div class="callsbycustomerandtype index">
	<h2><?php echo __('Toll-Free calls per DID');?></h2>
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $item['Callrecordmaster']['originatingnumber']?></td>
		<td><?php echo $item[0]['Calls']?></td>
		<td><?php echo $item[0]['RawMinutes']?></td>
		<td><?php echo $item[0]['BilledMinutes']?></td>
		<td><?php echo $item[0]['RetailPrice']?></td>
	</tr>
<?php endforeach; ?>
	</table>
	<p>
